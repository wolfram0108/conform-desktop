...
Критерий безопасности для A/W/D/B/E — файл не открывался за живой прогон (карта модулей
стенда `research/conform_standalone_build`) И не является статической зависимостью

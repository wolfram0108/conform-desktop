...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "tracks.n": {"ru": "дорожек в файле: {n}", "en": "{n} tracks in file"},
    ...
    "task.added": {"ru": "Задача добавлена в очередь", "en": "Task added to the queue"},
    ...
    "q.autostart": {"ru": "запускать сразу", "en": "start immediately"},

"""Грубый проход: опора по КОНСЕНСУСУ надёжных кадров. Функции lis_nd, coarse_robust
перенесены из исследовательского прототипа БЕЗ изменений логики/констант.
